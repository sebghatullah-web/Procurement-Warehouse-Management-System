  ...
  <form method="get" class="row g-2 align-items-end">
    ...
    <div class="col-md-2"><label class="form-label small text-muted">منبع</label>
      <select name="source" class="form-select form-select-sm" data-autosubmit>
        ...
        <option value="direct" <?php echo $src==='direct'?'selected':''; ?>>مستقیم</option>
      </select></div>
    <div class="col-auto pt-3"><button class="btn btn-primary btn-sm" type="submit">فیلتر</button></div>
    <div class="col-auto pt-3"><a class="btn btn-outline-secondary btn-sm" href="<?php echo $base; ?>/reports/consumption.php">بازنشانی</a></div>
  </form>
</div>

<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <span><i class="bi bi-box-arrow-up me-2"></i>گزارش مصرف</span>
    <button class="btn btn-sm btn-outline-secondary" data-print><i class="bi bi-printer me-1"></i>چاپ</button>
  </div>
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
      <thead><tr><th>تاریخ</th><th>اداره</th><th>کالا</th><th>دسته‌بندی</th><th>تعداد</th><th>واحد</th><th>منبع</th><th>یادداشت</th></tr></thead>
      <tbody>
      ...
      <?php endforeach; ?>
      <?php if (count($rows) === 0): ?>
        <tr><td colspan="8" class="text-center text-muted py-4">رکورد مصرفی یافت نشد.</td></tr>
      <?php endif; ?>
      </tbody>
    </table>
  </div>
