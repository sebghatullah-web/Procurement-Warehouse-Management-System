...
<div class="row g-3 mb-3">
  <div class="col-lg-6">
    <div class="card h-100">
      ...
      <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
        <thead><tr><th>Req No</th><th>Department</th><th>Item</th><th>Status</th></tr></thead>
        <tbody>
  ...
  <div class="col-lg-6">
    <div class="card h-100">
      <div class="card-header text-danger"><i class="bi bi-exclamation-triangle me-2"></i>Low Stock Items</div>
      <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
...
<div class="card mb-4">
  <div class="card-header"><i class="bi bi-currency-dollar me-2"></i>Latest Purchases</div>
  <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
