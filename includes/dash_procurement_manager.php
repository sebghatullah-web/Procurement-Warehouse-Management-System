...
<div class="row g-3 mb-3">
  <div class="col-lg-6">
    <div class="card h-100">
      <div class="card-header">Requests Awaiting Your Review</div>
      <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
        ...
        <?php endforeach; ?>
        <?php if (count($pending) === 0): ?><tr><td colspan="4" class="text-center text-muted py-3">Review queue is clear &#127881;</td></tr><?php endif; ?>
        </tbody>
      </table></div>
    </div>
  </div>
  <div class="col-lg-6">
    <div class="card h-100">
      <div class="card-header">Requests In Purchase Flow</div>
      <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
        <thead><tr><th>No</th><th>Department</th><th>Item</th><th>Status</th></tr></thead>
        <tbody>
        ...
        <?php endforeach; ?>
        <?php if (count($buying) === 0): ?><tr><td colspan="4" class="text-center text-muted py-3">No active purchases.</td></tr><?php endif; ?>
        </tbody>
      </table></div>
    </div>
  </div>
...
<div class="card mb-4">
  <div class="card-header d-flex justify-content-between align-items-center">
    <span><i class="bi bi-cart-check me-2"></i>Recent Purchases</span>
    <a class="small" href="<?php echo $base; ?>/purchases/list.php">All purchases &rarr;</a>
  </div>
  <div class="table-responsive"><table class="table table-sm table-hover align-middle mb-0">
    <thead><tr><th>PO No</th><th>Request</th><th>Supplier</th><th>Total (PKR)</th><th>Status</th><th>Date</th></tr></thead>
    <tbody>
